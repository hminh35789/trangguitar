(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CartComponent = /** @class */ (function () {
                ...
                CartComponent.prototype.total = function (index) {
                    return this.items[index].price * this.soluong[index];
                };
                CartComponent.prototype.tien = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailComponent = /** @class */ (function () {
                function DetailComponent(rout, ps, cart) {
                    this.rout = rout;
                    this.ps = ps;
                    this.cart = cart;
                ...
                DetailComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var pid = +this.rout.snapshot.paramMap.get('pid');
                    this.ps.getAllProduct().subscribe(function (p) {
                        _this.listproduct = p;
                        _this.product = _this.listproduct.find(function (x) { return x.id === pid; });
                        _this.feature = _this.product.newfeature;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var GuimailComponent = /** @class */ (function () {
                function GuimailComponent() {
                }
                GuimailComponent.prototype.ngOnInit = function () {
                };
                return GuimailComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TrangchuComponent = /** @class */ (function () {
                function TrangchuComponent(http) {
                    this.http = http;
                    this.url = './assets/guitar.json';
                }
                TrangchuComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getAllProduct().subscribe(function (data) {
                        _this.products = data;
                    });
                };
                TrangchuComponent.prototype.getAllProduct = function () {
